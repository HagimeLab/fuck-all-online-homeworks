...
```
5.配置好了后，就直接在目录下的cmd终端输入python main.py就行
...
## 效果图 ##
<img width="1403" height="701" alt="屏幕截图 2026-05-16 224824" src="https://github.com/user-attachments/assets/c416ad5b-e3e7-4757-955d-90df43b0383b" />
